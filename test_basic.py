...
def test_imports():
    ...
    try:
        ...
        print("✓ GuardrailService imported")
        
        from services.chart_service import ChartService
        print("✓ ChartService imported")
...
def test_data_service():
    ...
    try:
        ...
        print(f"✓ Data loaded: {len(countries)} countries")
        ...
        if len(countries) > 0:
            ...
            print(f"✓ Got data for {test_country}: {len(data)} rows")
...
def test_guardrail_service():
    ...
    try:
        ...
        print("✓ Blocked data extraction query")
        ...
        print("✓ Blocked reverse engineering query")
        
        print("✓ GuardrailService tests passed!")
        return True
        
    except Exception as e:
        print(f"✗ GuardrailService error: {e}")
        import traceback
        traceback.print_exc()
        return False
